...
class OperacionListaComponent {
    ...
    ngOnInit() {
        this.ticketService.getTicketNoPagados().subscribe((response) => {
...
OperacionListaComponent.ɵfac = function OperacionListaComponent_Factory(t) { return new (t || OperacionListaComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_servicios_ticket_service__WEBPACK_IMPORTED_MODULE_1__["TicketService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_servicios_util_service__WEBPACK_IMPORTED_MODULE_2__["UtilService"])); };
...
/* harmony import */ var _servicios_ticket_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../../servicios/ticket.service */ "./src/app/servicios/ticket.service.ts");
/* harmony import */ var _servicios_plaza_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../../servicios/plaza.service */ "./src/app/servicios/plaza.service.ts");
/* harmony import */ var _servicios_util_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../../servicios/util.service */ "./src/app/servicios/util.service.ts");
...
function OperacionTicketComponent_div_33_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](5);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"]("", ctx_r1.importe, " Euros");
} }
class OperacionTicketComponent {
    // se colocan los metodos de los servicios llamados en el constructor
    constructor(fb, ticketService, plazaService, utilService) {
        this.fb = fb;
        this.ticketService = ticketService;
    ...
    formatearEntrada() {
        this.entradaFormateada = this.utilService.formatearFecha(new Date(this.ticket.entrada));
    }
    formatearSalida() {
        this.salidaFormateada = this.utilService.formatearFecha(new Date(this.ticket.salida));
    }
    pagarTicket() {
...
OperacionTicketComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: OperacionTicketComponent, selectors: [["app-operacion-ticket"]], decls: 34, vars: 8, consts: [[1, "row"], [1, "container-fluid", "mt-4"], [1, "tituloText"], [1, "row", "justify-content-center"], [1, "col-auto", "mb-3"], [1, "card"], [1, "card-body"], [1, "tituloTextCard"], [1, "container"], [3, "formGroup", "ngSubmit"], ["placeholder", "Matricula", "type", "text", "formControlName", "matricula", "required", "", 1, "form-control", "form-control-dark"], ["type", "submit", 1, "btn", "btn-warning", 3, "disabled"], ["placeholder", "N\u00BA de Ticket", "type", "text", "formControlName", "numeroTicket", "required", "", 1, "form-control", "form-control-dark"], ["id", "modalTicket", "aria-hidden", "true", 1, "modal", "fade"], [1, "modal-dialog", "modal-sm"], ["class", "modal-content", 4, "ngIf"], ["id", "modalFactura", "aria-hidden", "true", 1, "modal", "fade"], [1, "modal-content"], [1, "modal-header"], [1, "modal-title"], [1, "row", "modal-body"], [1, "container", "col-md-6", "mb-3"], [1, "col-md-6", "mb-3"], [1, "modal-footer"], ["type", "button", "data-dismiss", "modal", 1, "btn", "btn-warning"], ["src", ".\\assets\\img\\logo.png", "alt", "SIGEPARK", "title", "Sistema de Gesti\u00F3n de Parking", "width", "50"]], template: function OperacionTicketComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](10, "ADMISI\u00D3N");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](27, " VALIDAR ");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](OperacionTicketComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }, { type: _servicios_ticket_service__WEBPACK_IMPORTED_MODULE_3__["TicketService"] }, { type: _servicios_plaza_service__WEBPACK_IMPORTED_MODULE_4__["PlazaService"] }, { type: _servicios_util_service__WEBPACK_IMPORTED_MODULE_5__["UtilService"] }]; }, null); })();
